...
public class AlarmSettings
{
    ...
    {
        ["AirAlarm"] = new AlarmSettings { Id = "AirAlarm", DisplayName = "Воздушная сигнализация", Icon = "🔊", Color = Color.FromArgb(200, 255, 200, 100), AutoLinkDevices = true },
        ["FireAlarm"] = new AlarmSettings { Id = "FireAlarm", DisplayName = "Пожарная сигнализация", Icon = "🔥", Color = Color.FromArgb(200, 255, 100, 100), AutoLinkDevices = true }
    };
}