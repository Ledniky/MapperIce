...
public class Execution : SecurityPlusRoomType
{
    public override string Name => "Execution";
    public override string DoorProto => "AirlockSecurityLocked";
    public override string GlassDoorProto => "AirlockSecurityGlassLocked";
    public override Color FillColor => Color.FromArgb(100, 130, 30, 30);
    public override Color LineColor => Color.FromArgb(255, 130, 30, 30);
}
